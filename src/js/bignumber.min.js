/* bignumber.js v2.0.7 https://github.com/MikeMcl/bignumber.js/LICENCE */ ! function (e) {
    "use strict";
    ...
    function n(e) {
        function a(e, n) {
            ...
            if (s = s.slice(i, u + 1))
                if (u = s.length, o && j && u > 15 && L(M, b, f.s * e), r = r - i - 1, r > z) f.c = f.e = null;
        ...
        function D(e, n, t, i) {
            ...
            if (!g[0]) return "0";
            if (0 > d ? --u : (h.c = g, h.e = u, h.s = i, h = C(h, p, m, w, n), g = h.c, c = h.r, u = h.e), o = u + m + 1, d = g[o], f = n / 2, c = c || 0 > o || null != g[o + 1], c = 4 > w ? (null != d || c) && (0 == w || w == (h.s < 0 ? 3 : 2)) : d > f || d == f && (4 == w || c || 6 == w && 1 & g[o - 1] || w == (h.s < 0 ? 8 : 7)), 1 > o || !g[0]) e = c ? l("1", -m) : "0";
            else {
                if (g.length = o, c)
        ...
        function _(e, n, t, i) {
            ...
            if (o = e.c[0], s = e.e, null == n) h = r(e.c), h = 19 == i || 24 == i && B >= s ? f(h, s) : l(h, s);
            else if (e = U(new a(e), n, t), u = e.e, h = r(e.c), c = h.length, 19 == i || 24 == i && (u >= n || B >= u)) {
                for (; n > c; h += "0", c++);
                h = f(h, u)
        ...
        function U(e, n, t, r) {
            ...
            if (a) {
                e: {
                    ...
                    r ? (n -= e.e + 1, a[0] = h[n % y], e.e = -n || 0) : a[0] = e.e = 0,
                    e;
        ...
        return a.another = n, a.ROUND_UP = 0, a.ROUND_DOWN = 1, a.ROUND_CEIL = 2, a.ROUND_FLOOR = 3, a.ROUND_HALF_UP = 4, a.ROUND_HALF_DOWN = 5, a.ROUND_HALF_EVEN = 6, a.ROUND_HALF_CEIL = 7, a.ROUND_HALF_FLOOR = 8, a.EUCLID = 9, a.config = function () {
            ...
            return function (e) {
                var t, r, i, o, u, s = 0,
                    f = [],
                    l = new a(q);
                if (e = null != e && H(e, 0, E, 14) ? 0 | e : P, o = d(e / y), V)
            ...
            return function (i, o, u, s, f) {
                var l, c, h, g, p, d, w, v, b, O, S, R, A, E, D, _, x, F = i.s == o.s ? 1 : -1,
                    I = i.c,
                    L = o.c;
                ...
                if (L[h] > (I[h] || 0) && c--, 0 > F) b.push(1), g = !0;
                else {
                    ...
                    do {
                        if (p = 0, l = n(L, O, _, S), 0 > l) {
                            if (R = O[0], _ != S && (R = R * f + (O[1] || 0)), p = m(R / D), p > 1)
                                for (p >= f && (p = f - 1), d = e(L, p, f), w = d.length, S = O.length; 1 == n(d, O, w, S);) p--, r(d, w > _ ? x : L, w, f), w = d.length, l = 1;
                            else 0 == p && (l = p = 1), d = L.slice(), w = d.length;
                            if (S > w && d.unshift(0), r(O, d, S, f), S = O.length, -1 == l)
                                for (; n(L, O, _, S) < 1;) p++, r(O, S > _ ? x : L, S, f), S = O.length
                        } else 0 === l && (p++, O = [0]);
                        b[h++] = p, O[0] ? O[S++] = I[A] || 0 : (O = [I[A]], S = 1)
                    } while ((A++ < E || null != O[0]) && F--);
            ...
            if (l = t(l), c = t(c), h = h.slice(), f = l - c) {
                ...
                for (i = (u = (f = h.length) < (n = g.length)) ? f : n, f = n = 0; i > n; n++)
                    if (h[n] != g[n]) {
                        u = h[n] < g[n];
                        break
                    } if (u && (o = h, h = g, g = o, e.s = -e.s), n = (i = g.length) - (r = h.length), n > 0)
                for (; n--; h[r++] = 0);
            for (n = N - 1; i > f;) {
                if (h[--i] < g[i]) {
                    for (r = i; r && !h[--r]; h[r] = n);
            ...
            var r, i, o, u, s, f, l, c, h, g, p, d, m, w, v, b = this,
                O = b.c,
