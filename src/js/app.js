App = {
  ...
  initContract: function () {
    $.getJSON('FlightSeatsBooker.json', function (flightSeatsBooker) {
      // Get the necessary contract artifact file and instantiate it with truffle-contract
      var FlightSeatslBookerArtifact = flightSeatsBooker;
      App.contracts.FlightSeatslBooker = TruffleContract(FlightSeatslBookerArtifact);

      // Set the provider for our contract
      App.contracts.FlightSeatslBooker.setProvider(App.web3Provider);
  ...
  render: function () {
    ...
    App.contracts.FlightSeatslBooker.deployed().then(function (instance) {
      ...
      return flightsInstance.getFlightIdsForAirline(airlines[j]).then(function (flightIds)
      {
  ...
  generateBoardingPass: function (event) {
    ...
    App.contracts.FlightSeatslBooker.deployed().then(function (instance) {
      ...
      flightsInstance.contract.checkinBuyer(seatId, barcodeString, ipfsUrl, transactionObject, function(err, boardingPassId) {
        if (!err) {
